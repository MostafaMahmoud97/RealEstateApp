...
class AddNewUnit extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            "media.*.extention" => "required|in:jpg,png,jpeg,mp4,avchd,mov,webm,avi,flv,wmv",
    ...
    {
        return [
            "real_estate_id.required" => __("real_estate_client.you must enter real estate id"),
            "real_estate_id.numeric" => __("real_estate_client.you must enter real estate id as number"),
            ...
            "unit_number_parking_lots.numeric" => __("real_estate_client.you must enter number parking lots as number"),
