...
class UpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "units.*.id.required" => __("real_estate_client.you must send unit id"),
            "units.*.id.numeric" => __("real_estate_client.you must send unit id as number"),
            ...
            "new_units.array" => __("real_estate_client.you must add unit as array"),
            "new_units.min" => __("real_estate_client.you must add min 1 unit"),
            "new_units.*.purpose_property_id.required" => __("real_estate_client.you must choose purpose property"),
            "new_units.*.purpose_property_id.numeric" => __("real_estate_client.you must choose purpose property and send id number"),
            "new_units.*.price.required" => __("real_estate_client.you must enter price"),
            "new_units.*.price.numeric" => __("real_estate_client.you must enter price as number"),
            "new_units.*.unit_type.required" => __("real_estate_client.you must enter unit type"),
            "new_units.*.unit_type.string" => __("real_estate_client.you must enter unit type as string"),
            "new_units.*.unit_number.required" => __("real_estate_client.you must enter unit number"),
            "new_units.*.unit_number.string" => __("real_estate_client.you must enter unit number as string"),
            "new_units.*.floor_number.numeric" => __("real_estate_client.you must enter floor number as number"),
            "new_units.*.unit_area.required" => __("real_estate_client.you must enter unit area"),
            "new_units.*.unit_area.numeric" => __("real_estate_client.you must enter unit area as number"),
            "new_units.*.furnished.string" => __("real_estate_client.you must enter furnished as string"),
            "new_units.*.composite_kitchen_cabinets.boolean" => __("real_estate_client.you must enter furnished as boolean 1 or 0"),
            "new_units.*.ac_type.string" => __("real_estate_client.you must enter ac_type as string"),
            "new_units.*.num_ac_units.numeric" => __("real_estate_client.you must enter num_ac_units as numeric"),
            "new_units.*.electricity_meter_number.numeric" => __("real_estate_client.you must enter electricity meter number as numeric"),
            "new_units.*.electricity_meter_reading.numeric" => __("real_estate_client.you must enter electricity meter reading as numeric"),
            "new_units.*.gas_meter_number.numeric" => __("real_estate_client.you must enter gas meter number as numeric"),
            "new_units.*.gas_meter_reading.numeric" => __("real_estate_client.you must enter gas meter reading as numeric"),
            "new_units.*.water_meter_number.numeric" => __("real_estate_client.you must enter water meter number as numeric"),
            "new_units.*.water_meter_reading.numeric" => __("real_estate_client.you must enter water meter reading as numeric"),
            "new_units.*.description.string" => __("real_estate_client.you must enter description as string"),
            "new_units.*.is_publish.required" => __("real_estate_client.you must choose is_publish"),
            "new_units.*.description.boolean" => __("real_estate_client.you must choose is_publish as yes or no"),
            "new_units.*.media.required" => __("real_estate_client.you must choose unit media"),
            "new_units.*.media.array" => __("real_estate_client.you must choose unit media as array"),
            "new_units.*.unit_length.numeric" => __("real_estate_client.you must enter unit length as number"),
            "new_units.*.unit_direction.string" => __("real_estate_client.you must enter unit direction as string"),
            "new_units.*.number_parking_lots.numeric" => __("real_estate_client.you must enter number parking lots as number"),
            "new_units.*.sign_area.numeric" => __("real_estate_client.you must enter sign area as number"),
            "new_units.*.sign_location.string" => __("real_estate_client.you must enter sign location as string"),
            "new_units.*.special_sign_specification.string" => __("real_estate_client.you must enter special sign specification as string"),
            "new_units.*.insurance_policy_number.numeric" => __("real_estate_client.you must enter insurance policy number as number"),
            "new_units.*.mezzanine.boolean" => __("real_estate_client.you must enter mezzanine as boolean yes or no"),
            "new_units.*.unit_finishing.boolean" => __("real_estate_client.you must enter unit finishing as boolean yes or no"),
        ];
    }
}
